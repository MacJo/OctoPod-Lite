...
#import "piThirdViewController.h"

@interface piThirdViewController ()

@end

@implementation piThirdViewController
...
- (void) send_data : (NSString*) statement execute : (NSString*) command{
    ...
    NSLog(@"In the send data the server value is: @%",var_ud_server);
