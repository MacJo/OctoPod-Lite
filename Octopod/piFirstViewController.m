...
@interface piFirstViewController ()
...
- (void)viewDidLoad{
    ...
    if ([var_ud_server length]!=0 || [var_ud_apikey length]!=0) {
        ...
        [lbl_stateString    setAlpha:0],[lbl_bedTemp setAlpha:0],[lbl_extruderTemp setAlpha:0],[lbl_progress setAlpha:0],[lbl_printTimeLeft setAlpha:0],[lbl_printTime setAlpha:0],[lbl_filename setAlpha:0],[lbl_filesize setAlpha:0],[img_waiting_octo setAlpha:1];
...
- (void) jsonrequest {
    ...
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",var_ud_server,url_statement]]];
...
- (void)connectionDidFinishLoading:(NSURLConnection*)connection{
    ...
    if(cnt_stringstate > 10){
        ...
        //Making the labels invisibles
        [lbl_stateString setAlpha:0];
        [lbl_bedTemp setAlpha:0];
        [lbl_extruderTemp setAlpha:0];
        [lbl_progress setAlpha:0];
        [lbl_printTimeLeft setAlpha:0];
        [lbl_printTime setAlpha:0];
        [lbl_filename setAlpha:0];
        [lbl_filesize setAlpha:0];
