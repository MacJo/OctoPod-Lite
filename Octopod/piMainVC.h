...
@interface piMainVC: UIViewController{
    NSArray *arraydata;
    NSMutableData *data;
    NSTimer *time;
...
@property (strong, nonatomic) IBOutlet UILabel *lbl_stateString,*lbl_extruderTemp,*lbl_bedTemp,*lbl_printTime,*lbl_printTimeLeft,*lbl_filename,*lbl_filesize,*lbl_progress;
